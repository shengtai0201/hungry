<template>
  <q-card class="no-shadow" bordered>
    ...
    <q-card-section>
      <q-btn fab color="teal-7" icon="fas fa-cart-plus" padding="sm" class="absolute"
    ...
    <q-card-section>
      ...
      <div>
        <q-rating v-model="data.rating" max="5" size="1.5em" color="yellow" icon="star_border" icon-selected="star"
          icon-half="star_half" readonly no-dimming />
      </div>
    </q-card-section>
    <q-card-section>
      <div class="col-12">
