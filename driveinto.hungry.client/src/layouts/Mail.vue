  ...
  <q-layout view="hHh lpR fFf" class="bg-grey-1">
    <q-header class="bg-white text-grey-8">
      <q-toolbar class="GNL__toolbar">
        ...
        <q-btn flat dense round @click="$q.screen.gt.sm ? toogleMiniState() : toggleLeftDrawer()" aria-label="Menu"
    ...
    <q-page-container>
      <q-list class="q-ma-sm q-mt-md">
        <q-expansion-item v-for="(mail, index) in mail_data" :key="index" style="border-radius: 10px" popup
