        ...
        <q-stepper v-model="step" header-nav ref="stepper" color="primary" class="no-shadow" bordered animated>
          ...
          <q-step :name="2" title="Payment details" icon="shopping_cart" :done="step > 2" :header-nav="step > 2">
            ...
            <div class="row">
              ...
              <div class="col-6">
                <q-item>
                  <q-input dense outlined class="full-width" v-model="address_detail.card_number" label="Card Number *" />
                </q-item>
              </div>
              <div class="col-6">
                <q-item>
          ...
          <q-step :name="3" title="Review your order" icon="shopping_cart" :header-nav="step > 3">
            ...
            <q-stepper-navigation>
              ...
              <q-btn rounded @click="done3 = true" class="float-right q-mr-md q-mb-md" color="blue" label="Place Order" />
